...
namespace RecordNavigator.MusicSalesDataSetTableAdapters {
    ...
    public partial class ArtistsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Artists] WHERE (([Artist] = @Original_Artist) AND ([Company] = @Orig" +
                "inal_Company) AND ((@IsNull_Sales = 1 AND [Sales] IS NULL) OR ([Sales] = @Origin" +
                "al_Sales)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Artists] ([Artist], [Company], [Sales]) VALUES (@Artist, @Company, @" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Artists] SET [Artist] = @Artist, [Company] = @Company, [Sales] = @Sales WHERE (([Artist] = @Original_Artist) AND ([Company] = @Original_Company) AND ((@IsNull_Sales = 1 AND [Sales] IS NULL) OR ([Sales] = @Original_Sales)));
SELECT Artist, Company, Sales FROM Artists WHERE (Artist = @Artist)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Artist, Company, Sales\r\nFROM     Artists";
